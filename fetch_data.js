...
const SNOWFALL_DAILY_FILE = path.join(DATA_DIR, 'snowfall_daily.csv');
...
function calculateDailySnowfall() {
  ...
  if (fs.existsSync(SNOWFALL_DAILY_FILE)) {
    const dailyContent = fs.readFileSync(SNOWFALL_DAILY_FILE, 'utf-8');
